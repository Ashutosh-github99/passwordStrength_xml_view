package com.challange.passwordstrength
...
import com.challange.passwordstrength.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun resetDrawables() {
        val drawbleError = ContextCompat.getDrawable(this,R.drawable.ic_error)

        binding.hasLowerCase.setCompoundDrawablesWithIntrinsicBounds(drawbleError,null,null,null)
        binding.hasSymbol.setCompoundDrawablesWithIntrinsicBounds(drawbleError,null,null,null)
        binding.hasUpperCase.setCompoundDrawablesWithIntrinsicBounds(drawbleError,null,null,null)
